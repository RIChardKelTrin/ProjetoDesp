...
export default function PopupAcao({ navigation, veiculo, detalhar }) {
    ...
    return (
        <>
            <TouchableOpacity style={{ flex: 1, justifyContent: "center" }} onPress={() => { resizeBox(1) }}>
                <Icon name={"dots-three-vertical"} size={20}></Icon>
            </TouchableOpacity>

            <Modal transparent visible={visible}>
                <SafeAreaView style={styles.container} onTouchStart={() => resizeBox(0)}>
                    <Animated.View style={[
                        styles.popup,
                        {
                            transform: [{ scale }]
                        ...
                        <TouchableOpacity style={styles.botao} onPress={() => {setExpandir(!expandir), detalhar(expandir)}}>
                            {expandir ?
                                <>
                        ...
                        <TouchableOpacity style={styles.botao} onPress={() => { ExcluirVeiculo() }}>
