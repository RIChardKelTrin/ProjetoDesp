  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity style={styles.buttonTouch} onPress={() => navigation.navigate('CadastrarServico')}>
        ...
        <TouchableOpacity style={styles.buttonTouch} onPress={() => navigation.navigate('DeletarServico')}>
          <Text style={styles.TextTitulo}><MaterialCommunityIcons name="delete-empty" size={18} color="white" /> DELETAR SERVIÇO</Text>
        </TouchableOpacity>
      </View>
      <Marca></Marca>
    </View>
